...
*Electron renderer ��̬��Դ���� frontend build ʱ���ɣ�ʵ�ʴ���ɹ��̻Ὣ `frontend/dist` �����ڴ��ڵ� renderer �ļ���*
...
*   Packaging 之前请分别对 backend (`npm run build`) 和 frontend (`npm run build`) 进行构建，以便 Electron Forge 自动复制 renderer/back-end 产物。
