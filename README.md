...
- `.env` ���� `PORT`��`FRONTEND_URL`��`API_BASE_PATH`��`DATABASE_URL`��Ĭ�� `file:./apps/backend/data/portfolio.db`���Ⱥ�� / Launcher ��Ϊ
- `frontend/.env` 通过 `VITE_API_BASE_URL` 决定前端调用的后端地址

如需更改端口�?API 前缀，仅需修改上述文件并重新启动相关服务�?
## ���ݿ�

���Ĭ��ʹ�� SQLite��ͨ�� Prisma �����������ݿ��ļ�λ�� `apps/backend/data/portfolio.db`����ͨ�� `.env` �е� `DATABASE_URL` �Զ��壩��
